Feature: Post creation plus button
  ...
  Scenario: As a user I create a post using plus button on home page
    ...
    Then I enter "Fri May 21 16:37:06 COT 20211935076657GueGdlPn8E" into input field having css selector ".gh-editor-title"
    ...
    Then I should see text "Fri May 21 16:37:06 COT 20211935076657GueGdlPn8E"
