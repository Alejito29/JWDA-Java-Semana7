Feature: Create a new tag
  ...
  Scenario: As a user I create a new tag on on tag manage menu
    ...
    Then I enter "Fri May 21 16:37:04 COT 20215845860527OWwq7MoNE" into input field having xpath "(//input[@id='tag-name'])[1]"
    ...
    Then I should see text "Fri May 21 16:37:04 COT 20215845860527OWwq7MoNE"
