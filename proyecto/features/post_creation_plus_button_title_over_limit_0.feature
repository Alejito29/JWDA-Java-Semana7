Feature: Post creation plus button
  ...
  Scenario: As a user I create a post using plus button on home page
    ...
    Then I enter "Intuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIntuitive radical modelIn" into input field having css selector ".gh-editor-title"
